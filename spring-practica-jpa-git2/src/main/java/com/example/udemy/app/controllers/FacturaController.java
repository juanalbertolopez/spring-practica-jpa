...
public class FacturaController {
	...
	public String ver(@PathVariable(value="id") Long id,
		...
		if(factura == null) {
			flash.addFlashAttribute("error", "La factura no se existe en la base de datos!");
	...
	public String guardar(@Valid Factura factura,
		...
		for(int i = 0; i< itemId.length; i ++) {
			...
			if(cantidad[i]>producto.getStock()) {
				model.addAttribute("error", "Error: La cantidad es mayor que el stock del producto:" + producto.getNombre());
				return "factura/form";
